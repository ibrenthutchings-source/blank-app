...
// Modal shell
// ─────────────────────────────────────────────────────────────
export function Modal({ open, onClose, title, sub, children, footer, width = 540 }) {
  React.useEffect(() => {
    if (!open) return;
...
// Form field bits
// ─────────────────────────────────────────────────────────────
export function Lab({ k, hint, children }) {
  return (
...
// New Policy modal
// ─────────────────────────────────────────────────────────────
export function NewPolicyModal({ open, onClose, onCreated }) {
...
// ─────────────────────────────────────────────────────────────
export function ExceptionModal({ open, onClose, run, check }) {
  const toast = useToast();
...
// ─────────────────────────────────────────────────────────────
export function VerifyChainOverlay({ open, onDone }) {
