// module-library.jsx — Policy library list

function Library({ setRoute, setSelected }) {
    ...
    <div className="lr-page">
      <PageHeader
        ...
        actions={<>
          ...
          <button className="lr-btn primary" onClick={() => window.__openNewPolicy?.()}>+ New Policy</button>
        </>}
      />
